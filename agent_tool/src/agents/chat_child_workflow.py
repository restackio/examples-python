            ...
            for tool_call in tool_calls:
                ...
                match name:
                    case SalesWorkflow.__name__:
                        args = SalesWorkflowInput.model_validate_json(tool_call.function.arguments)
                        ...
                        completion_with_tool_call = await workflow.step(llm_chat, LlmChatInput(messages=self.messages, tools=tools), start_to_close_timeout=timedelta(seconds=120))
